        ...
        <CardContent className="p-8">
          ...
          <form onSubmit={handleCustomLogin} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 border-gray-200 hover:border-[#8ECAE6] focus:border-[#219EBC]"
                  required
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 pr-10 border-gray-200 hover:border-[#8ECAE6] focus:border-[#219EBC]"
                  required
                />
                <button
                  type="button"
            ...
            <Button
              ...
              className="w-full bg-gradient-to-r from-[#8ECAE6] to-[#219EBC] text-white font-medium py-3 px-4 hover:from-[#219EBC] hover:to-[#023047] transition-all duration-300 shadow-lg hover:shadow-xl"
            >
              {isLoading ? (
                <>
